#' Tagbio templates from R Markdown
#'
#' This function is a slight reworking of the \code{\link[prettydoc]{html_pretty}}
#' method used to create HTML document from R Markdown. It uses templates
#' that work well within the tagbio platform.
#'
...
#' }
#' @export
tag_report <- function(theme = "default-color",
                        highlight = NULL,
                        css = NULL,
  ...
  # `css` parameter to Pandoc. html_vignette() is a good and simple example of
  ...
  pre_processor <- function(metadata, input_file, runtime, knit_meta,
    ...
    pandoc_flags <- c(pandoc_flags, "--css", doc_css, "--resource-path", files_dir)
    pandoc_flags
  }
